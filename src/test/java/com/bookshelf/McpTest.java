...
public class McpTest {
    ...
    static void startServer() throws IOException, InterruptedException {
        ...
        BookCsvController csvController = new BookCsvController(repository, null);
        Router router = App.createRouter(controller, statsController, csvController, shelfController, mcpController, goalController, authController);
